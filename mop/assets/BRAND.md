# Scruffy repair assets

The repair workflow uses the same single Scruffy identity as the rest of the
product. Dashboards load `../../assets/scruffy-hero.png`; they do not introduce
a second character or a companion-product mark.
